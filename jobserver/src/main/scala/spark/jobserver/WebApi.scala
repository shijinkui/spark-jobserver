...
import spark.jobserver.JobInfoActor.GetJobConfig
import spark.jobserver.akka.web.{CommonRoutes, WebService}
...
class WebApi(system: ActorSystem,
  ...
  jarManager: ActorRef,
  supervisor: ActorRef,
  jobInfo: ActorRef) extends HttpService with CommonRoutes {
