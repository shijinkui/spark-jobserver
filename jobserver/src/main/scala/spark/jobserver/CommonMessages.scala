...
object CommonMessages {
  ...
  case class JobValidationFailed(jobId: String, endTime: DateTime,
    err: Throwable) extends StatusMessage
  ...
  // all events for this jobId and receiving actor
  ...
  case object WrongJobType

  // Job type C does not match context type
  case object JobInitAlready

  case class NoJobSlotsAvailable(maxJobSlots: Int)
